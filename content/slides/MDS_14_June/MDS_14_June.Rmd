...
#ggplotly(linear_libcon_mental_health_plot) %>% layout(legend = list(orientation = "h")) %>% reverse_legend_labels()
...
- include ATE Conditional on active on SM
...
- include ATE conditional on SM Contents
